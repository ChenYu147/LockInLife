...
#define BLE_UUID_NUS_TX_CHARACTERISTIC 0xFEC7                      /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC 0xFEC8                      /**< The UUID of the RX Characteristic. */
